...
def compute_md5(msg: str) -> str:
    ...
    # except ValueError:
    #     print("Could not find definition in file. Searching in general.")
    #     try:
    #         definition = asnParser.g_names[msg]
    #     except KeyError:
    #         panic("Couldn't find definition of %s! Failing..." % (msg))
    #
    ...
    #             buff.write("%s %s\n" %
    #                        (compute_md5(asnFile, member_type), member[0]))
    ...
    #                     # TODO: Check if this is correct according to message generation
    #                     buff.write("%s %s\n" %
    #                                (compute_md5(asnFile, contained_type),
    #                                 member[0]))
    ...
    #                 print(contained_type)
    #                 if contained_type in primitive_types.keys():
    #                     buff.write("%s%s %s" %
    #                                (primitive_types[contained_type],
    #                                 array_str, member[0]))
    #                 else:
    #                     # Must find the type somehow
    #                     print("I don't know the type...")
    #                 print(type(member), member, member_type, leaf_type)
    #         elif member_type in primitive_types.keys():
    #             buff.write("%s %s\n" %
    #                        (primitive_types[member_type], member[0]))
    #         else:
    #             # TODO: Try to find type. If you fail panic
    #             pass
    #     print("")
